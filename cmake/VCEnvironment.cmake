...
macro(TextEditWithClangCodeCompletion_detect_architecture)
...
function(TextEditWithClangCodeCompletion_run_vcvarsall)
  ...
  if(MSVC AND "$ENV{VSCMD_VER}" STREQUAL "")
    ...
    if(EXISTS ${VCVARSALL_FILE})
      # detect the architecture
      TextEditWithClangCodeCompletion_detect_architecture()
